            ...
            >
              ...
              <div className="mt-6">
                <button
                  ...
                  className="bg-[#407338] hover:bg-[#1e6113]  px-4 rounded-xl py-2 text-white hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl cursor-pointer"
                >
                  Book Consultation
                </button>
              </div>
